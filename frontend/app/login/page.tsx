  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-dark-primary">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-neon-purple/20 rounded-full blur-3xl animate-pulse-slow" />
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-neon-blue/20 rounded-full blur-3xl animate-pulse-slow" style={{ animationDelay: '1s' }} />
      </div>
      ...
      >
        ...
        >
          ...
          <p className="text-sm sm:text-base text-text-secondary">Sign in to continue your musical journey</p>
        </motion.div>
        ...
        >
          <p className="text-text-secondary">
            ...
            <Link href="/signup" className="text-neon-purple hover:text-neon-blue font-medium transition-colors">
              Sign up
            </Link>
          </p>
